...
| --- | --- | --- | --- | --- |
| sdkwork-manager-common | shared | no | Shared TypeScript contracts, client-core, and service helpers. | [README](sdkwork-manager-common/README.md) |
| sdkwork-manager-pc | pc | yes | SDKWork Manager PC application root. | `sdkwork-manager-pc/` |
