-- SDKWork manager consolidated initialization baseline (postgres)
...
-- baseline source: ddl/baseline/postgres/0001_manager_baseline.sql
...
-- folded migration: migrations/postgres/0002_manager_commercial_entitlements.up.sql
-- sdkwork:migration
